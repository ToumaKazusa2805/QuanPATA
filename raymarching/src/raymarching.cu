...
__global__ void kernel_march_rays_train(
    ...
    if (!first_pass) {
        // if not first pass, rays[0] is point index and rays[1] is num_steps of current ray
    ...
    while (t < far && step < num_steps) {
        ...
        // advance along with the ray, 距离采样起点越远，步长dt就越大
